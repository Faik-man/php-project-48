...
function format(array $tree): string
{
    ...
    $iter = function (string $propertyName, mixed $propertyValue, int $depth = 1) use (&$iter): string {
        ...
        $str = $spaces . toString($propertyName) . ": {\n" .
            implode(",\n", $updatedProperties) . "\n" .
            $spaces . "}";
...
function createJsonObject(array $tree): object
{
